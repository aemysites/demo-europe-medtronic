...
## Environments
- Preview: https://main--demo-europe-medtronic--aemysites.aem.page/
- Live: https://main--demo-europe-medtronic--aemysites.aem.live/
- Block Library: https://main--demo-europe-medtronic--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `demo-europe-medtronic` directory in your favorite IDE and start coding :)
